...
/* harmony import */ var _lib_sanityClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("FwU/");
...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  return new Promise(resolve => {
    ...
    _lib_sanityClient__WEBPACK_IMPORTED_MODULE_0__[/* writeClient */ "a"].fetch(query).then(comment => {
      if (comment) {
        _lib_sanityClient__WEBPACK_IMPORTED_MODULE_0__[/* writeClient */ "a"].patch(comment._id).set({
          reactions: reactions
        }).commit().then(() => {
          resolve(res.status(200).end());
        });
      } else {
        _lib_sanityClient__WEBPACK_IMPORTED_MODULE_0__[/* writeClient */ "a"].create({
...
module.exports = __webpack_require__("+v66");
