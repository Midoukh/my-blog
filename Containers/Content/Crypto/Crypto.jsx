	...
	return(
		<section className={styles.Crypto}>
			<div className={styles.Head}>
				...
				<img src={badge} alt="Crypto badge icon" onMouseOver={handleChangeBadge} onMouseLeave={handleChangeBadgeAgain}/>
			</div>
			<Blogs data={data}/>
			<div className={styles.ShowMore}><ShowMoreButton content="CryptoCurrencies Posts"/></div>
