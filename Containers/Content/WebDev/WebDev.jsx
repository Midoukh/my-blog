	...
	return(
		<section className={styles.WebDev}>
			<div className={styles.Head}>
				<h1>WebDev</h1>
				<img src={badge} alt="Latest badge icon" onMouseOver={handleChangeBadge} onMouseLeave={handleChangeBadgeAgain}/>
			</div>
			<Blogs data={data}/>
			<div className={styles.ShowMore}><ShowMoreButton content="WebDev Posts"/></div>
