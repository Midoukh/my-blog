	...
	return(
		<section className={styles.BooksAndResources}>
			<div className={styles.Head}>
				...
				<img src={badge} alt="BooksAndResources badge icon" onMouseOver={handleChangeBadge} onMouseLeave={handleChangeBadgeAgain}/>
			</div>
			<Blogs data={data}/>
			<div className={styles.ShowMore}><ShowMoreButton content="Books and Resources Posts"/></div>
